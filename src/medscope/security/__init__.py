"""medscope.security — deterministic input sanitization and PII/secret redaction.
...
3. Output facing: redact scrubs PII and secret tokens before surfacing to
   operators or logs.
"""
from medscope.security.sanitize import detect_injection, neutralize_untrusted, normalize
from medscope.security.redact import redact
